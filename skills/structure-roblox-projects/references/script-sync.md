...
4. Narrow the boundary to authorized work when it contains protected content. Use [`modification-scope.md`](modification-scope.md) when a required script, folder, attribute/tag preservation step, or consumer update crosses that boundary.
